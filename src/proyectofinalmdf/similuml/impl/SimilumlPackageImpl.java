...
import proyectofinalmdf.similuml.Parametro;
import proyectofinalmdf.similuml.Realizacion;
import proyectofinalmdf.similuml.Relacion;
import proyectofinalmdf.similuml.SimilumlFactory;
import proyectofinalmdf.similuml.SimilumlPackage;
import proyectofinalmdf.similuml.Tipo_Predefinido;
import proyectofinalmdf.similuml.Tipo_Predefinido_Retorno;
import proyectofinalmdf.similuml.Tipo_Visibilidad;

import proyectofinalmdf.similuml.util.SimilumlValidator;
...
public class SimilumlPackageImpl extends EPackageImpl implements SimilumlPackage {
	 ...
	 * @see proyectofinalmdf.similuml.SimilumlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		addEEnumLiteral(tipo_Predefinido_RetornoEEnum, Tipo_Predefinido_Retorno.INT_LITERAL);
		addEEnumLiteral(tipo_Predefinido_RetornoEEnum, Tipo_Predefinido_Retorno.FLOAT_LITERAL);
		addEEnumLiteral(tipo_Predefinido_RetornoEEnum, Tipo_Predefinido_Retorno.CHAR_LITERAL);
		addEEnumLiteral(tipo_Predefinido_RetornoEEnum, Tipo_Predefinido_Retorno.BOOLEAN_LITERAL);
		addEEnumLiteral(tipo_Predefinido_RetornoEEnum, Tipo_Predefinido_Retorno.STRING_LITERAL);
		addEEnumLiteral(tipo_Predefinido_RetornoEEnum, Tipo_Predefinido_Retorno.DOUBLE_LITERAL);
		addEEnumLiteral(tipo_Predefinido_RetornoEEnum, Tipo_Predefinido_Retorno.VOID_LITERAL);

		initEEnum(tipo_VisibilidadEEnum, Tipo_Visibilidad.class, "Tipo_Visibilidad");
		addEEnumLiteral(tipo_VisibilidadEEnum, Tipo_Visibilidad.PRIVATE_LITERAL);
		addEEnumLiteral(tipo_VisibilidadEEnum, Tipo_Visibilidad.PUBLIC_LITERAL);
		addEEnumLiteral(tipo_VisibilidadEEnum, Tipo_Visibilidad.PACKAGE_LITERAL);
		addEEnumLiteral(tipo_VisibilidadEEnum, Tipo_Visibilidad.PROTECTED_LITERAL);

		initEEnum(tipo_PredefinidoEEnum, Tipo_Predefinido.class, "Tipo_Predefinido");
		addEEnumLiteral(tipo_PredefinidoEEnum, Tipo_Predefinido.INT_LITERAL);
		addEEnumLiteral(tipo_PredefinidoEEnum, Tipo_Predefinido.FLOAT_LITERAL);
		addEEnumLiteral(tipo_PredefinidoEEnum, Tipo_Predefinido.CHAR_LITERAL);
		addEEnumLiteral(tipo_PredefinidoEEnum, Tipo_Predefinido.BOOLEAN_LITERAL);
		addEEnumLiteral(tipo_PredefinidoEEnum, Tipo_Predefinido.STRING_LITERAL);
		addEEnumLiteral(tipo_PredefinidoEEnum, Tipo_Predefinido.DOUBLE_LITERAL);
