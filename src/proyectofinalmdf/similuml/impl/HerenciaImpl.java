 ...
 * </p>
 * <ul>
 *   <li>{@link proyectofinalmdf.similuml.impl.HerenciaImpl#getHerenciaClase_Origen <em>Herencia Clase Origen</em>}</li>
 *   <li>{@link proyectofinalmdf.similuml.impl.HerenciaImpl#getHereda_Clase_Destino <em>Hereda Clase Destino</em>}</li>
 *   <li>{@link proyectofinalmdf.similuml.impl.HerenciaImpl#getHereda_Interfaz_Origen <em>Hereda Interfaz Origen</em>}</li>
 *   <li>{@link proyectofinalmdf.similuml.impl.HerenciaImpl#getHereda_Interfaz_destino <em>Hereda Interfaz destino</em>}</li>
 *   <li>{@link proyectofinalmdf.similuml.impl.HerenciaImpl#getNombre <em>Nombre</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HerenciaImpl extends EObjectImpl implements Herencia {
	/**
