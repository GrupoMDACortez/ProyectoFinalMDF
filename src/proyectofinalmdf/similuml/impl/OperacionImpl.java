 ...
 * </p>
 * <ul>
 *   <li>{@link proyectofinalmdf.similuml.impl.OperacionImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link proyectofinalmdf.similuml.impl.OperacionImpl#getTipo_retorno <em>Tipo retorno</em>}</li>
 *   <li>{@link proyectofinalmdf.similuml.impl.OperacionImpl#getParametros_contenidos <em>Parametros contenidos</em>}</li>
 *   <li>{@link proyectofinalmdf.similuml.impl.OperacionImpl#isEsAbstracto <em>Es Abstracto</em>}</li>
 *   <li>{@link proyectofinalmdf.similuml.impl.OperacionImpl#getVisibilidad <em>Visibilidad</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperacionImpl extends EObjectImpl implements Operacion {
	/**
	 ...
	 * @ordered
	 */
	protected static final Tipo_Predefinido_Retorno TIPO_RETORNO_EDEFAULT = Tipo_Predefinido_Retorno.INT_LITERAL;
	 ...
	 * @ordered
	 */
	protected EList parametros_contenidos;
	 ...
	 * @ordered
	 */
	protected static final Tipo_Visibilidad VISIBILIDAD_EDEFAULT = Tipo_Visibilidad.PRIVATE_LITERAL;
	 ...
	 * @generated
	 */
	public EList getParametros_contenidos() {
		if (parametros_contenidos == null) {
			parametros_contenidos = new EObjectContainmentEList(Parametro.class, this, SimilumlPackage.OPERACION__PARAMETROS_CONTENIDOS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SimilumlPackage.OPERACION__ES_ABSTRACTO:
				return isEsAbstracto() ? Boolean.TRUE : Boolean.FALSE;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimilumlPackage.OPERACION__PARAMETROS_CONTENIDOS:
				...
				getParametros_contenidos().addAll((Collection)newValue);
				return;
			case SimilumlPackage.OPERACION__ES_ABSTRACTO:
				setEsAbstracto(((Boolean)newValue).booleanValue());
				return;
			case SimilumlPackage.OPERACION__VISIBILIDAD:
