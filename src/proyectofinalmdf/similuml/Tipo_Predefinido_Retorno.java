 ...
 * <!-- end-user-doc -->
 * @see proyectofinalmdf.similuml.SimilumlPackage#getTipo_Predefinido_Retorno()
 * @model
 * @generated
 */
public final class Tipo_Predefinido_Retorno extends AbstractEnumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final Tipo_Predefinido_Retorno INT_LITERAL = new Tipo_Predefinido_Retorno(INT, "int", "int");
	 ...
	 * @ordered
	 */
	public static final Tipo_Predefinido_Retorno FLOAT_LITERAL = new Tipo_Predefinido_Retorno(FLOAT, "float", "float");
	 ...
	 * @ordered
	 */
	public static final Tipo_Predefinido_Retorno CHAR_LITERAL = new Tipo_Predefinido_Retorno(CHAR, "char", "char");
	 ...
	 * @ordered
	 */
	public static final Tipo_Predefinido_Retorno BOOLEAN_LITERAL = new Tipo_Predefinido_Retorno(BOOLEAN, "boolean", "boolean");
	 ...
	 * @ordered
	 */
	public static final Tipo_Predefinido_Retorno STRING_LITERAL = new Tipo_Predefinido_Retorno(STRING, "String", "String");
	 ...
	 * @ordered
	 */
	public static final Tipo_Predefinido_Retorno DOUBLE_LITERAL = new Tipo_Predefinido_Retorno(DOUBLE, "double", "double");
	 ...
	 * @ordered
	 */
	public static final Tipo_Predefinido_Retorno VOID_LITERAL = new Tipo_Predefinido_Retorno(VOID, "void", "void");
