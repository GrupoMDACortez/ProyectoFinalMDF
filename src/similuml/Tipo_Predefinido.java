 ...
 * <!-- end-user-doc -->
 * @see similuml.SimilumlPackage#getTipo_Predefinido()
 * @model
 * @generated
 */
public enum Tipo_Predefinido implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	public static final List<Tipo_Predefinido> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
