...
public class SimilumlValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "similuml";
	 ...
	 * @generated
	 */
	public boolean validateDiagramaClases(DiagramaClases diagramaClases, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateClase(Clase clase, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(clase, diagnostics, context)) return false;
		...
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(clase, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(clase, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(clase, diagnostics, context);
	 ...
	 * @generated
	 */
	public boolean validateClase_clase_distinta_de_alumno(Clase clase, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(createDiagnostic
						(Diagnostic.ERROR,
						 ...
						 new Object[] { "clase_distinta_de_alumno", getObjectLabel(clase, context) },
						 new Object[] { clase },
						 context));
			}
			return false;
	 ...
	 * @generated
	 */
	public boolean validateRelacion(Relacion relacion, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateComposicion(Composicion composicion, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateOperacion(Operacion operacion, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateParametro(Parametro parametro, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateRealizacion(Realizacion realizacion, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateConstantesInterfaces(ConstantesInterfaces constantesInterfaces, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateTipo_Predefinido_Retorno(Tipo_Predefinido_Retorno tipo_Predefinido_Retorno, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateTipo_Visibilidad(Tipo_Visibilidad tipo_Visibilidad, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateTipo_Predefinido(Tipo_Predefinido tipo_Predefinido, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
