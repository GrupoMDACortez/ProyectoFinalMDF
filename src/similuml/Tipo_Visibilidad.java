 ...
 * <!-- end-user-doc -->
 * @see similuml.SimilumlPackage#getTipo_Visibilidad()
 * @model
 * @generated
 */
public enum Tipo_Visibilidad implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	public static final List<Tipo_Visibilidad> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
