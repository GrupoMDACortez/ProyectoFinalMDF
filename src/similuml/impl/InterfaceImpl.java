 ...
 * </p>
 * <ul>
 *   <li>{@link similuml.impl.InterfaceImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link similuml.impl.InterfaceImpl#getOperaciones_iterfaces <em>Operaciones iterfaces</em>}</li>
 *   <li>{@link similuml.impl.InterfaceImpl#getContantes_Interfaces <em>Contantes Interfaces</em>}</li>
 *   <li>{@link similuml.impl.InterfaceImpl#getHerenciasInterfaz_contenidas <em>Herencias Interfaz contenidas</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceImpl extends MinimalEObjectImpl.Container implements Interface {
	 ...
	 * @ordered
	 */
	protected EList<Operacion> operaciones_iterfaces;
	 ...
	 * @ordered
	 */
	protected EList<ConstantesInterfaces> contantes_Interfaces;
	 ...
	 * @ordered
	 */
	protected EList<Herencia> herenciasInterfaz_contenidas;
	 ...
	 * @generated
	 */
	public EList<Operacion> getOperaciones_iterfaces() {
		if (operaciones_iterfaces == null) {
			operaciones_iterfaces = new EObjectContainmentEList<Operacion>(Operacion.class, this, SimilumlPackage.INTERFACE__OPERACIONES_ITERFACES);
		}
	 ...
	 * @generated
	 */
	public EList<ConstantesInterfaces> getContantes_Interfaces() {
		if (contantes_Interfaces == null) {
			contantes_Interfaces = new EObjectContainmentEList<ConstantesInterfaces>(ConstantesInterfaces.class, this, SimilumlPackage.INTERFACE__CONTANTES_INTERFACES);
		}
	 ...
	 * @generated
	 */
	public EList<Herencia> getHerenciasInterfaz_contenidas() {
		if (herenciasInterfaz_contenidas == null) {
			herenciasInterfaz_contenidas = new EObjectContainmentEList<Herencia>(Herencia.class, this, SimilumlPackage.INTERFACE__HERENCIAS_INTERFAZ_CONTENIDAS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimilumlPackage.INTERFACE__OPERACIONES_ITERFACES:
				...
				getOperaciones_iterfaces().addAll((Collection<? extends Operacion>)newValue);
				return;
			case SimilumlPackage.INTERFACE__CONTANTES_INTERFACES:
				getContantes_Interfaces().clear();
				getContantes_Interfaces().addAll((Collection<? extends ConstantesInterfaces>)newValue);
				return;
			case SimilumlPackage.INTERFACE__HERENCIAS_INTERFAZ_CONTENIDAS:
				getHerenciasInterfaz_contenidas().clear();
				getHerenciasInterfaz_contenidas().addAll((Collection<? extends Herencia>)newValue);
				return;
		}
