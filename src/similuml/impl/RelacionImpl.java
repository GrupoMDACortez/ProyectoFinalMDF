 ...
 * </p>
 * <ul>
 *   <li>{@link similuml.impl.RelacionImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link similuml.impl.RelacionImpl#getCardinalidadInferior <em>Cardinalidad Inferior</em>}</li>
 *   <li>{@link similuml.impl.RelacionImpl#getCardinalidadSuperior <em>Cardinalidad Superior</em>}</li>
 *   <li>{@link similuml.impl.RelacionImpl#getOrigen <em>Origen</em>}</li>
 *   <li>{@link similuml.impl.RelacionImpl#getDestino <em>Destino</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SimilumlPackage.RELACION__CARDINALIDAD_INFERIOR:
				return getCardinalidadInferior();
			case SimilumlPackage.RELACION__CARDINALIDAD_SUPERIOR:
				return getCardinalidadSuperior();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SimilumlPackage.RELACION__NOMBRE:
				...
				return;
			case SimilumlPackage.RELACION__CARDINALIDAD_INFERIOR:
				setCardinalidadInferior((Integer)newValue);
				return;
			case SimilumlPackage.RELACION__CARDINALIDAD_SUPERIOR:
				setCardinalidadSuperior((Integer)newValue);
				return;
			case SimilumlPackage.RELACION__ORIGEN:
